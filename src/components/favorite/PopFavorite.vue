        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="input-group container-sm px-5">
                    <span class="input-group-text mt-5" id="addon-wrapping">
                        <img src="../../assets/img/icon3 1.png" id="icon-pikachu" alt=""></span>
                    <input type="text" class="form-control mt-5" name="Pokename" placeholder="Pokename" id="pokename"
                        aria-describedby="addon-wrapping" v-model="pokename">
                </div>
                <div class="input-group container-sm px-5">
                    <span class="input-group-text mt-5" id="addon-wrapping"><i class="bi bi-lightning-charge"></i></span>
                    <input type="text" class="form-control mt-5" name="pokecharge" placeholder="Pokecharge" id="pokecharge"
                        v-model="pokecharge">
                </div>
                <div class="input-group container-sm px-5">
                    <span class="input-group-text mt-5" id="addon-wrapping">H</span>
                    <input type="text" class="form-control mt-5" name="pokeheight" placeholder="Pokeheight" id="pokeheight"
                        aria-describedby="addon-wrapping" v-model="pokeheight">
                </div>
                <div class="input-group container-sm px-5">
